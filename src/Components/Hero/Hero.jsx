    ...
    return (
        <div id='hero' className='flex flex-col justify-center items-center space-y-5'>
            ...
            <div className='flex gap-5 mb-10'>
                <button className='text-lg font-medium border-2 border-[#3E84F6] rounded-full px-5 py-2 hover:shadow-md hover:shadow-[#3E84F6] transition duration-300'>
                    Sign in
                </button>

                <button className='text-lg font-medium border-2 border-[#3E84F6] bg-[#3E84F6] text-white rounded-full px-5 py-2 hover:shadow-md hover:shadow-[#3E84F6] transition duration-300'>
                    Sign up
                </button>
            </div>
