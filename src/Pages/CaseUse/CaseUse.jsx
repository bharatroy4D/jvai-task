...
const CaseUse = () => {
    return (
        <div id='Case' className="bg-slate-900 min-h-screen p-8">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {/* Primary Care */}
                    <div className="bg-blue-900/30 border border-blue-800/50 rounded-lg p-8">
                        ...
                        <div className="bg-blue-800/20 border-l-4 border-blue-400 p-6 rounded-r-lg">
